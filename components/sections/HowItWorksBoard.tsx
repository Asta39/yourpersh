...
/* Pinned-cards "how it works" board (vendored, kept close to the original). */
...
export default function HowItWorksBoard({
  features,
  className,
  stepPositions,
}: HowItWorksProps) {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        className={`bg-background max-md:pt-10 max-md:pb-25 md:py-20 px-8 relative ${className ?? ""}`}
      >
        <div
                ...
                {(() => {
                  ...
                  return (
                    <m.path
                      ...
                      animate={{
                        strokeDashoffset: reduceMotion ? 0 : -140, // Multiple of 14 (8+6) for seamless loop
                      }}
                      transition={{
                        duration: 3,
                        repeat: Infinity,
